...
export class AddSectionCommand implements Command {
  ...
  invert() {
    return new DeleteSectionCommand(this.nextDoc, this.prevDoc)
  }
  description() {
    return 'Add Section'
  }
...
export class DeleteSectionCommand implements Command {
  ...
  invert() {
    return new AddSectionCommand(this.nextDoc, this.prevDoc)
  }
  description() {
...
export class MoveSectionCommand implements Command {
  ...
  invert() {
    return new MoveSectionCommand(this.nextDoc, this.prevDoc)
  }
  description() {
    return 'Move Section'
  }
...
export class ToggleSectionVisibilityCommand implements Command {
  ...
  invert() {
    return new ToggleSectionVisibilityCommand(this.nextDoc, this.prevDoc)
  }
  description() {
    return 'Toggle Section Visibility'
  }
}
...
export class UpdateSectionTitleCommand implements Command {
  ...
  invert() {
    return new UpdateSectionTitleCommand(this.nextDoc, this.prevDoc)
  }
  description() {
