...
export class UpdateFieldValueCommand implements Command {
  ...
  invert() {
    return new UpdateFieldValueCommand(this.nextDoc, this.prevDoc, this.timestamp)
  }
  description() {
...
export class AddFieldCommand implements Command {
  ...
  invert() {
    return new DeleteFieldCommand(this.nextDoc, this.prevDoc)
  }
  description() {
    return 'Add Field'
  }
...
export class DeleteFieldCommand implements Command {
  ...
  invert() {
    return new AddFieldCommand(this.nextDoc, this.prevDoc)
  }
  description() {
    return 'Delete Field'
  }
