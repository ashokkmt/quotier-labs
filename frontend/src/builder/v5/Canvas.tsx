...
import {
  ...
  V5_TEXT_UNDERLINE_OFFSET_EM,
  V5_TEXT_UNDERLINE_THICKNESS_EM,
  ...
  return (
    <span
      style={{
        ...
        textUnderlineOffset: `${V5_TEXT_UNDERLINE_OFFSET_EM}em`,
        textDecorationThickness: `${V5_TEXT_UNDERLINE_THICKNESS_EM}em`,
