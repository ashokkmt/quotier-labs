...
!insertmacro MUI_PAGE_COMPONENTS # Optional shortcuts.
...
!ifdef QUOTIER_SIGN_RELEASE
  !uninstfinalize 'cmd /c "..\..\..\..\..\scripts\windows-sign.cmd" "%1"'
  !finalize 'cmd /c "..\..\..\..\..\scripts\windows-sign.cmd" "%1"'
!endif
...
Section
    ...
    # The running app launches update mode and exits immediately. Give Windows
    # time to release the executable before package-owned files are replaced.
    StrCmp $R9 "update" 0 +2
    Sleep 2000
