...
export QUOTIERLABS_DEV_ROOT="$QL_ROOT" QL_VERSION QL_PLATFORM_VERSION QL_APP_ID QL_NAME
...
node "$QL_ROOT/scripts/run-with-metadata.mjs" "$WAILS_BIN" build -clean -trimpath -ldflags "$QL_LDFLAGS"
